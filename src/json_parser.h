...
#define JS_SAX_IDLE							0
#define JS_SAX_IN_QUERYRESULT_MAP			1
#define JS_SAX_IN_ITEMS_VALUE				2
#define JS_SAX_IN_ITEMS_ARRAY				3
#define JS_SAX_IN_ITEM_MAP					4
#define JS_SAX_IN_ITEM_TYPE_VALUE			5
#define JS_SAX_IN_ITEM_NAME_VALUE			6
#define JS_SAX_IN_ITEM_ID_VALUE				7
#define JS_SAX_IN_ITEM_ARTISTS_ARRAY		8
#define JS_SAX_IN_ITEM_ABLUM_VALUE			9
#define JS_SAX_IN_ITEM_SERIES_VALUE			10
#define JS_SAX_IN_ITEM_YEAR_VALUE			11
#define JS_SAX_IN_ITEM_INDEX_VALUE			12
#define JS_SAX_IN_ITEM_PARENT_INDEX_VALUE	13
#define JS_SAX_IN_USERDATA_MAP				14
#define JS_SAX_IN_USERDATA_VALUE			15
#define JS_SAX_IN_USERDATA_TICKS_VALUE		16


// GENERIC JELLYFIN ITEM REPRESENTATION
#define JF_ITEM_TYPE_COLLECTION	0
#define JF_ITEM_TYPE_FOLDER		1
#define JF_ITEM_TYPE_PLAYLIST	2
#define JF_ITEM_TYPE_AUDIO		3
#define JF_ITEM_TYPE_ARTIST		4
#define JF_ITEM_TYPE_ALBUM		5
#define JF_ITEM_TYPE_EPISODE	6
#define JF_ITEM_TYPE_SEASON		7
#define JF_ITEM_TYPE_SERIES		8
#define JF_ITEM_TYPE_MOVIE		9
